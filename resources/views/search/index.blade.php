      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title"></h5>
            ...
            <form name="formulaire" class="col-8 offset-6"  action="" >
                ...
                @foreach ($reservations as $reservations)
                    ...
                    <tr  style="font-family: sans-serif; font-size:11px">
                        ...
                        <th>
                          ...
                          <a href="#"><button class="btn btn-success edit_btn_reserv offset-1" style='margin-left:-5px;font-size:10px' data-target="" data-id ="{{$reservations->idReserv}}"  data-toggle='modal'>View</button></a>
                        </th>
                        <th>
