          ...
          <div class="container ">
           <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <form class="row g-3 needs-validation " idu="EditForm" novalidate name="formulaire" method="POST" action="{{route('Utilisateur.update',$utilisateurs)}}"> 
             ...
             {{ csrf_field() }}
               ...
               <div class="card mb-3 modal-content">
                ...
                <div class="card-boody">
                  ...
                  <div class="pt-4 pb-2 ">
                    <h5 class="card-title text-center pb-0 fs-4"><b style="font-size: 30px;font-family: sans-serif;">Update User</b></h5>
                    @if(count($errors) > 0)
                      ...
                      @endif
                      <hr class="">
                      <input type="text"hidden class="form-control" name="idUser" id="idUser" value="">
                    ...
                    <div class="col-12">
                      ...
                      <div class="col-sm-10 offset-9 cs ">
                         ...
                         <button type="submit" name="submit" class="btn btn-primary col-md-3" data-dismiss="modal">Modify</button>
